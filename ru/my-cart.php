...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">Выбрать</th>
					<th class="cart-description item">Фото</th>
					<th class="cart-product-name item">Наименование</th>
			
					<th class="cart-qty item">Количество</th>
					<th class="cart-sub-total item">Стоимость</th>
					<th class="cart-sub-total item">Доставка</th>
					<th class="cart-total last-item">Сумма</th>
				</tr>
			</thead><!-- /thead -->
			<tfoot>
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Продолжать выбрать </a>
...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo " "." ".$row['shippingCharge']; ?>.00 Rub</span></td>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Дом</span>
				</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Сумма<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">ПЕРЕЙТИ К ОФОРМЛЕНИЮ ЗАКАЗА </button>

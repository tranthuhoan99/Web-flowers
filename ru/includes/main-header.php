...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="Искать здесь..." name="product" required="required" />
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price"><?php echo ($row['productPrice']+$row['shippingCharge']); ?>Rub*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Итог :</span><span class='price'><?php echo $_SESSION['tp']="$totalprice". ".00"; ?>Rub</span>
